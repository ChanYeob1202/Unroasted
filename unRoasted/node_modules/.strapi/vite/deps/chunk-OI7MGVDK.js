...
import {
  LimitsModal
} from "./chunk-SNKAU5EL.js";
import {
  useTypedSelector
} from "./chunk-XAS7TNRI.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-XU6KTG5M.js";
import {
  getStageColorByHex
} from "./chunk-UB4IDCYX.js";
import {
...
import {
  ...
  useGetLocalesQuery
} from "./chunk-LUEIJDCJ.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-BYXGJI6Y.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-V2NWNO5W.js";
import {
  useConfig
} from "./chunk-GMCMVIFC.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-XQKBSDX2.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-2S4DO76C.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-75ISPROX.js";
import {
  renderAdmin
} from "./chunk-CJS7XY2G.js";
import {
  useLicenseLimits
} from "./chunk-SB7CHUUD.js";
import {
  Table,
  useTable
} from "./chunk-R4A6ZP5U.js";
import {
  useField,
  useForm
} from "./chunk-7NPRVF5T.js";
import {
  useRBAC
} from "./chunk-NQPS3GHA.js";
import {
  require_omit
} from "./chunk-CHFCI5HQ.js";
import {
  require_cloneDeep
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-Q5SN6NIM.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
  require_has
} from "./chunk-XY65PK22.js";
import {
  useAdminUsers
} from "./chunk-NH66XBOR.js";
import {
  useTracking
} from "./chunk-5GP57ZNW.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-Q675KZCR.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-DKFPNDIN.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-ETN37SUH.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-2QISCLIT.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-VCGMNAMK.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-7UWP3QD3.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-PCDCJGE2.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-QUDTRI5T.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-C3EG2LSM.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-MYUTCXGK.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-DDDXBOMN.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-I77K4YI5.js");
          return {
...
//# sourceMappingURL=chunk-OI7MGVDK.js.map
