    ...
    <div className="flex flex-col md:flex-row items-start gap-8 bg-white/50 rounded-xl p-6 shadow-sm">
      <div className="md:w-2/3">
        <p className="mb-4 text-lg text-gray-700 font-extralight leading-relaxed">
          Hi, I'm Michael. As both a software engineer and manger at specialty coffee shop, I've discovered a unique intersection where precision meets craft. My journey weaves together the analytical world of coding with the artistry of coffee making.
        </p>
